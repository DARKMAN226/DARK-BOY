...
const sessdata = config.SESSION_ID.replace("SPI~XMD~", '');
...
const port = process.env.PORT || 9090;
  ...
  console.log('Commandes installé ✅')
  console.log('Bot connecté à whatsapp ✅')
  
let up = `
╔════════════════════════════════╗
║     👻 DARK-BOY WHATSAPP BOT     ║
╚════════════════════════════════╝

✦ Simplicité. Vitesse. Puissance.  
✦ Codé avec 💀 par DARK-DEV

┌───〔 🔗 LIENS RAPIDES 〕───┐
│ 📢 Chaine :(https://whatsapp.com/channel/0029VbAfF6f1dAw7hJidqS0i)
│ ⭐ GitHub :[étoile](https://github.com/DARKMAN226/DARK-BOY)
│ ⚙️ Préfixe : \`${prefix}\`
└───────────────────────────┘

> _© 2025 DARK-DEV. Tous droits réservés._
`;

    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/u4g4te.png` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('22603582906', '22603582906', '22603582906');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("22603582906")){
  if(isReact) return
  m.react( )
   }
  //==========public react============//
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("𝔻𝔸ℝ𝕂-𝔹𝕆𝕐 EST EN LIGNE");
  });
